...
if __name__ == "__main__":
    ...
    Broccoli = Plant("Broccoli", "🥦", 165, 200, 250, C.light_green)
    ...
    Banana = Plant("Banana", "🍌", 800000, 910000, 1000000, C.gold)
    Onion = Plant("Onion", "🧅", 1500000, 2200000, 3100000, C.yellow)
    Kiwi = Plant("Kiwi", "🥝", 13500000, 15000000, 18000000, C.green) 
    ...
    Frozen = Mutation("Frozen", "🧊", 30, 0.01)
    Gem = Mutation("Gem", "💎", 100, 0.005)
    Interstellar = Mutation("Interstellar", "🌌", 150, 0.007)
